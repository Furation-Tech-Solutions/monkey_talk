...
import 'package:monkey_talk/core/injectable_modules/logger_injectable_module.dart'
    as _i15;
import 'package:monkey_talk/core/logger/applogger.dart' as _i8;
import 'package:monkey_talk/data/auth/datasources/auth_remote_ds.dart' as _i10;
import 'package:monkey_talk/data/auth/repo_impl/auth_repo_impl.dart' as _i11;
import 'package:monkey_talk/domain/auth/repos/auth_repo.dart' as _i7;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i6.SignInWithEmailAndPasswordUsecase>(
        () => _i6.SignInWithEmailAndPasswordUsecase(gh<_i7.AuthRepo>()));
    gh.lazySingleton<_i8.AppLogger>(() => _i8.AppLoggerImpl(gh<_i5.Logger>()));
    gh.singleton<_i9.AuthCubit>(_i9.AuthCubit(
      gh<_i3.FirebaseAuth>(),
      gh<_i4.HiveInterface>(),
      gh<_i8.AppLogger>(),
    ));
    gh.lazySingleton<_i10.AuthRemoteDS>(() => _i11.AuthRemoteDSImpl(
          gh<_i3.FirebaseAuth>(),
          gh<_i8.AppLogger>(),
        ));
    gh.factory<_i12.LoginCubit>(() => _i12.LoginCubit(
        signInWithEmailAndPasswordUsecase:
            gh<_i6.SignInWithEmailAndPasswordUsecase>()));
    return this;
  }
}
